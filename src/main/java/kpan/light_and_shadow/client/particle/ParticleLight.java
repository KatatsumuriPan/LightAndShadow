...
public class ParticleLight extends ParticleBlockConditional {

    public ParticleLight(World world, double x, double y, double z) {
        super(world, x, y, z, ItemInit.LIGHT);
    }
    ...
    protected @Nullable ResourceLocation getTexture() {
        ...
        return new ResourceLocation(ModTagsGenerated.MODID,
                "textures/items/light_" + String.format("%02d", BlockInit.LIGHT_BLOCK.getLightValue(state)) + ".png");
    }
    @Override
